...
export const AllCases = () => {
  ...
  const handleUpdateJustices = async (data) => {
    ...
    await endpoint
      .put(`/justice/update/${selectedRow.id}`, data)
      .then((res) => {
        setLoading(false);
        console.log(res);
        getAssignedJusticeList();
  ...
  const columns = [
    ...
    },
    {
      ...
      width: "300px",
      cell: (row) => <div className="fs-12 fw-bold ">{row.Justice.name}</div>,
    },
    ...
    // {
    // 	name: "Actions",
    // 	selector: (row) => [row.Justice.role_id],
    ...
    // 					onClick={()=>
    //                         {
    //                             setSelectedRow({id:row.Justice.id, name:row.Justice.name, rank:row.Justice.rank ,email:row.Justice.email, phone_number:row.Justice.phone_number    });
    //                             openEditModal()}
    //                        }
    // 				>
    // 					Edit
    ...
    // 					onClick={() => {
    // 						setSelectedRow({id:row.Justice.id, name:row.Justice.name   });
    // 						openDeleteModal();
    // 					}}
    // 				>
            ...
            <div className="card">
              <div className="card-body">
                <p className="card-description text-center">
                  {" "}
                  Please confirm you want to delete Justice {
                    selectedRow.name
                  }?{" "}
                </p>
          ...
          <div className="col-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <p className="card-description text-center">
                  {" "}
                  Edit Justices Record{" "}
                </p>
                <form
                  className="forms-sample"
                  onSubmit={handleSubmit(handleUpdateJustices)}>
                  <Form.Group>
