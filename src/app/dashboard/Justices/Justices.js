...
export const AllCases = () => {
  ...
  <div className="header-container" style={style}>
    <Header />
    <button className=" btn btn-success push-right" onClick={ openCreateJusticeModal}>Create Justice</button>
  </div>
            ...
            <Modal show={createJusticesModal} >
				...
				<div className="row">
					<div className="col-12 grid-margin stretch-card">
						<div className="card">
							<div className="card-body">
								<p className="card-description text-center"> Register Justices </p>
