...
const CauseListCounsel = () => {
  ...
  const handleFetchData = async () => {
    ...
    await endpoint
      .get(
        `/justice/assigned-list/${justicesDate.startDate}/${justicesDate.endDate}`
      )
      .then((res) => {
                    ...
                    <div className="card">
                      <div className="card-body">
                        <h4 className="card-title text-center text-underline">
                          <p>IN THE NATIONAL INDUSTRIAL COURT OF NIGERIA</p>
                          <p>HOLDEN AT ABUJA</p>
                          <p>{sittingDates}</p>
                          <p>BEFORE THEIR LORDSHIPS</p>
                        </h4>
