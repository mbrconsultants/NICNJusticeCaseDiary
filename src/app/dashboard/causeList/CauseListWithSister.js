                                                        ...
                                                        items.map((item, index) => (
                                                            <>
                                                                {item.CaseAttachements && item.CaseAttachements.map((Case, index2) => (
                                                                    <tr key={`${index}-${index2}`} style={{ border: `1px solid black` }}>
                                                                        {(index2 === 0) && <td rowSpan={item.CaseAttachements.length} style={{ border: `1px solid black` }}>{index + 1}.</td>}
                                                                        <td style={{ border: `1px solid black`, color: `${item.CaseType.case_color}` }}>{Case.suite_no}</td>
                                                                        {headings.toUpperCase().includes("APPEAL") ?
                                                                            <>
                                                                            ...
                                                                            <>
                                                                                ...
                                                                                <td className='text-center' style={{ whiteSpace: `normal`, border: `1px solid black` }}>
                                                                                    <tr>{Case.appellants}</tr>
                                                                                    <tr>({Case.appellants_title}(s))</tr>
                                                                                    <tr><div className='mt-2 mb-2'>VS.</div></tr>
                                                                                    <tr>{Case.respondent}</tr>
                                                                                    <tr>({Case.respondent_title}(s))</tr>
                                                                                </td>
                                                                                <td style={{ whiteSpace: `pre-wrap`, border: `1px solid black`, wordWrap: `break-word` }}>{Case.case_desc}</td>
