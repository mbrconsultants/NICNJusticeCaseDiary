																				...
																				<div className="card-body">
																								...
																								<form className="forms-sample" onSubmit={handleCreateCase}>
																												...
																												<Form.Group>
																																...
																																<select className="form-control" value={caseDetails.case_type_cat_id} onChange={(e)=> {
																																				setCaseDetails({ ...caseDetails, case_type_cat_id: e.target.value }) }}
																																				>
																																				<option value="">--Select--</option>
																																				{casesCat.map((casecat) => (
																																				<option key={casecat.id} value={casecat.id}
																																								selected={casecat.id===caseDetails.case_type_cat_id}>
																												...
																												<Form.Group>
																																<label htmlFor="exampleInputName1">Case Description/Application </label>
																																<Form.Control as="textarea" rows={3} className="form-control" id="exampleInputName1"
																																				placeholder="Enter case description/application" value={caseDetails.case_desc}
																																				onChange={(e)=> { setCaseDetails({ ...caseDetails, case_desc: e.target.value }) }}
																																				/>
																												</Form.Group>
