...
export const SisterCase =({sistercaseList}) =>{
					...
					<div className="col-12 grid-margin">
						<div className="card">
							<div className="card-body">
								<h4 className="card-title  text-center"  >CASES</h4>
								<div className="table-responsive">
									<table className="table">
										...
										{sistercaseList && sistercaseList.CaseAttachements.map((s, index)=>
											<tr key={s.id}>
                      <td>{index+1}</td>
                      <td>{s.Case.suite_no}</td>
                      <td>{s.Case.parties}</td>
                      <td>
                        <button
                          // onClick={openEditModal}
                          className="btn btn-primary btn-sm"
                          onClick={() => openViewModal(s.Case.parties, s.Case.suite_no)}
                        >
                          View
                        </button>
                        <button
