  ...
  return (
    <nav className="sidebar sidebar-offcanvas" id="sidebar">
	  ...
	  <li className="nav-item nav-profile">
        ...
        {modules.map((sidebar) => (
          <li className="nav-item" key={sidebar.module_name}>
            <div
              className="nav-link"
            ...
            >
              ...
              <i className={`menu-arrow ${activeSubMenu === sidebar.module_name ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down'}`}></i>
              ...
              <ul className="nav flex-column sub-menu">
                {sidebar.SubModules &&
                  sidebar.SubModules.map((sub) => (
                    <li className="nav-item" key={sub.submodule_name}>
                      <Link
                        className={isPathActive(sub.route) ? "nav-link active" : "nav-link"}
                        to={sub.route}
                      >
...
{currentUser.role_id === 1 && (
  <li className="nav-item mt-5">
    <div
      className={activeSubMenu === "rolePageOpen" ? "nav-link menu-expanded" : "nav-link"}
    ...
    >
      ...
      <i className={`menu-arrow ${activeSubMenu === "rolePageOpen" ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down'}`}></i>
